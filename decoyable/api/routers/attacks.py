...
@router.get("/attacks/{attack_id}", summary="Get Attack Details", description="Retrieve detailed information about a specific attack")
async def get_attack_details(attack_id: str) -> Dict[str, Any]:
    ...
    try:
        ...
        return {
            "status": "success",
            "attack": mock_attack_details[attack_id]
        }
